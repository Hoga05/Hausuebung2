                ...
                switch (option) {
                    case 1:
                        while (rechenoperation == 5) {
                            ...
                            switch (rechenoperation) {
                                case 1:
                                    Number n1 = r.add(new Number(xa, ya), new Number(xb, yb));
                                    System.out.println("Solution:");
                                    System.out.println("a = " + n1.getA());
                                    System.out.println("b = " + n1.getB());
                                    break;
                                case 2:
                                    Number n2 = r.subt(new Number(xa, ya), new Number(xb, yb));
                                    System.out.println("a = " + n2.getA());
                                    System.out.println("b = " + n2.getB());
                                    break;
                                case 3:
                                    Number n3 = r.mult(new Number(xa, ya), new Number(xb, yb));
                                    System.out.println("a = " + n3.getA());
                                    System.out.println("b = " + n3.getB());
                                    break;
                                case 4:
                                    Number n4 = r.divi(new Number(xa, ya), new Number(xb, yb));
                    ...
                    case 2:
                        while (rechenoperation == 5) {
                            ...
                            switch (rechenoperation) {
                                case 1:
                                    Number n1 = c.add(new Number(xa, ya), new Number(xb, yb));
                                    System.out.println("Solution:");
                                    System.out.println("a = " + n1.getA());
                                    System.out.println("b = " + n1.getB());
                                    break;
                                case 2:
                                    Number n2 = c.subt(new Number(xa, ya), new Number(xb, yb));
                                    System.out.println("Solution:");
                                    System.out.println("a = " + n2.getA());
                                    System.out.println("b = " + n2.getB());
                                    break;
                                case 3:
                                    Number n3 = c.mult(new Number(xa, ya), new Number(xb, yb));
                                    System.out.println("Solution:");
                                    System.out.println("a = " + n3.getA());
                                    System.out.println("b = " + n3.getB());
                                    break;
                                case 4:
                                    Number n4 = c.divi(new Number(xa, ya), new Number(xb, yb));
                                    System.out.println("Solution:");
                                    System.out.println("a = " + n4.getA());
                                    System.out.println("b = " + n4.getB());
                                    break;
